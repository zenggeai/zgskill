...
[![Skills](https://img.shields.io/badge/Skills-3-111111.svg)](#skill-全目录)
...
| 一句话生成公众号文章并保存到草稿箱 | `$wewrite` | 选题、框架、正文、SEO、配图、排版与草稿箱 |
...
npx -y skills add zenggeai/zgskill -g --skill wewrite
```
